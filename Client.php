...
//	$proxypassword = isset($_POST['proxypassword']) ? $_POST['proxypassword'] : '';
	...
	$client = new nusoap_client("http://79.127.101.174/webservice/Server/Services.php", FALSE,
...
//				         "EncryptKey"  => $updateObj->SecureEncrypt2($updateObj->GetPreMasterKey()), //Not Encrypted
